...
public class KidsPageAdapter extends PagerAdapter {
    Context context;
    List<MovieData> kidsBannerList;

    public KidsPageAdapter(Context context, List<MovieData> bannerMoviesList) {
        this.context = context;
        this.kidsBannerList = bannerMoviesList;
    }

    public void setKidsPageAdapter(List<MovieData> kidsBannerList) {
